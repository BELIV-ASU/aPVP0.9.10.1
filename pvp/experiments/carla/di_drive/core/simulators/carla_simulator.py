...
from pvp.experiments.carla.di_drive.core.utils.simulator_utils.sensor_utils import SensorHelper, CollisionSensor, \
    TrafficLightHelper
from pvp.experiments.carla.di_drive.core.simulators.base_simulator import BaseSimulator
...
class CarlaSimulator(BaseSimulator):
    ...
    def _spawn_hero_vehicle(self, start_pos: int = 0) -> None:
        ...
        print("=== Successfully spawn hero actor. ===")
    ...
    def _spawn_vehicles(self) -> None:
        ...
        for n, transform in enumerate(spawn_points):
            #print(f"Entering loop with index: {n}")
    ...
    def apply_planner(self, end_idx: int) -> Dict:
        ...
        print(f"🚗 规划起点: {self._start_location}")
        print(f"🏁 规划终点: {self._end_location}")
